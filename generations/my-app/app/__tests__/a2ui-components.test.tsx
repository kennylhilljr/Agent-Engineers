...
describe('A2UI Component Rendering', () => {
  describe('TaskCard', () => {
    test('renders with basic props', () => {
      ...
      expect(screen.getByText(/a2ui.TaskCard/i)).toBeInTheDocument();
    });

    test('displays component type', () => {
      const props: A2UIProps = {
        type: 'a2ui.TaskCard',
        data: { title: 'Test' },
      };
      ...
      render(<TaskCard {...props} />);
      expect(screen.getByText(/Component: a2ui.TaskCard/i)).toBeInTheDocument();
    });

    test('displays placeholder status', () => {
      const props: A2UIProps = {
        type: 'a2ui.TaskCard',
        data: {},
      };
      ...
      render(<TaskCard {...props} />);
      expect(screen.getByText(/Placeholder Implementation/i)).toBeInTheDocument();
    });
  });
  ...
  describe('DecisionCard', () => {
    test('renders with basic props', () => {
      ...
      expect(screen.getByText(/a2ui.DecisionCard/i)).toBeInTheDocument();
    });
  });
