...
Endpoints:
    ...
    POST /api/reasoning - Broadcast reasoning event (AI-158)
    POST /api/agent-thinking - Broadcast agent thinking event (AI-159)
    GET /api/reasoning/blocks - Return history of reasoning/thinking events (AI-160)
